...
if( ! class_exists( 'TFR_Skills' ) ) {
	...
	add_action( 'init', 'TFR_Skills::init', 0 );

	require plugin_dir_path(__FILE__) . 'class-tfr-skills-metabox.php';
	require plugin_dir_path(__FILE__) . 'class-tfr-skills-rest.php';
}
