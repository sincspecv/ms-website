...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$matthew_schroeter_description = get_bloginfo( 'description', 'display' );
			if ( $matthew_schroeter_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $matthew_schroeter_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
